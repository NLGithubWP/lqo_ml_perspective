...
# Default PG on (imdb_13, JOB_full test)
python3 run_test_queries.py --use_postgres --query_dir /data/datasets/imdb_queries/ori_queries --output_file log_vldb/test_pg_imdb_ori_query_full.log --database_name imdb_ori
