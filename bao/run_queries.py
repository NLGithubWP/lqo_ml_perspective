...
def main(args):
    ...
    for c_idx, chunk in enumerate(bao_chunks):
        ...
        if USE_BAO:
            ...
            os.system('cd bao_server && CUDA_VISIBLE_DEVICES="" python3 baoctl.py --retrain >> /app/AI4QueryOptimizer/experiment_setup/vldb_revision/job/res_bao/retrain.log 2>&1')
            os.system("sync")
