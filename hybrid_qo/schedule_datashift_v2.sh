...
mkdir logs && \
mkdir model && \
python run_mcts.py --query_file workload/query_join__train.json --train_database imdb_ori --test_database imdb_05v2 && \
...
mkdir logs && \
mkdir model && \
python run_mcts.py --query_file workload/query_join__train.json --train_database imdb_ori --test_database imdb_07v2 && \
