...
#
# @balsa.params_registry.Register
# class NB_Balsa_train_imdb_ori_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_ori'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Balsa_train_imdb_01v2_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_01v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Balsa_train_imdb_05v2_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_05v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Balsa_train_imdb_17v2_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_17v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_train_imdb_ori_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_ori'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_train_imdb_01v2_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_01v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_train_imdb_05v2_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_05v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_train_imdb_17v2_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_17v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Balsa_test_imdb_ori_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_ori'
#         # this is the path in docker
#         p.query_dir = current_used_test_query_glob_in_test
#         p.test_query_glob = ["2a.sql", "2b.sql", "2c.sql", "2d.sql"]
#         return p
#
#
# @balsa.params_registry.Register
# class NB_Balsa_test_imdb_01v2_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_01v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Balsa_test_imdb_05v2_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_05v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Balsa_test_imdb_17v2_job(Balsa_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_17v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_test_imdb_ori_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_ori'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_test_imdb_01v2_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_01v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_test_imdb_05v2_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_05v2'
#         # this is the path in docker
...
#
# @balsa.params_registry.Register
# class NB_Neo_test_imdb_17v2_job(Neo_JOB_EvaluationBase):
#     def Params(self):
#         p = super().Params()
#         p.db = 'imdb_17v2'
#         # this is the path in docker
